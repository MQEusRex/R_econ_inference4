...
**Code:**
```{r}
lm(q9pdcalq9~cash+credit+info,data=round1)
lm(exp_total_pc_r1~cash+credit+info,data=round1)
lm(hhmembers_r1~cash+credit+info,data=round1)
lm(tsaving_hh_r1~cash+credit+info,data=round1)
lm(hhh_education~cash+credit+info,data=round1)
lm(num_adltmalesr1~cash+credit+info,data=round1)
